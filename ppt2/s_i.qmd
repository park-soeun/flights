...
![](img\EMB.png){style="position: absolute; width: 100%; height: 100%;"}
...
![BOE](img\boe717.jpg){style="position: absolute; bottom: 50px; right: 50px; width: 50%; height: 60%;"}
![EMB](img\erj145_kp.jpg){width=60%}
